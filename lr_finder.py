...
# Author: https://github.com/davidtvs
# Original: https://github.com/davidtvs/pytorch-lr-finder/blob/master/torch_lr_finder/lr_finder.py
...
class DataLoaderIter(object):
    ...
    #     inputs, labels, *_ = dict2tuple(batch_data, keys=('data', 'label'))
    ...
    def __next__(self):
        batch = next(dict2tuple(self._iterator,keys=('data', 'label')))
        inputs, labels =batch
        return inputs, labels
...
class LRFinder(object):
    ...
    def range_test(
        ...
        for iteration in tqdm(range(num_iter)):
            print(f'Num iteration: {iteration}')
    ...
    def plot(
        ...
        if suggest_lr:
            ...
            if min_grad_idx is not None:
                ...
                ax.set_title("Suggested LR: {:.2E}".format(lrs[min_grad_idx]))
                ax.legend()
        ...
        if fig is not None and save_file is not None:
